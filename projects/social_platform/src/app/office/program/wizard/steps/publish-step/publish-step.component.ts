...
export class PublishStepComponent implements OnInit {
  ...
  readonly nextItems = [
    ...
    "Вы сможете уточнить дедлайны регистрации, сдачи проектов и оценки",
    "Вы сможете добавить обложку, материалы, критерии оценки и экспертов",
    "Для закрытого чемпионата добавьте приглашения или подготовьте ссылку доступа в разделе редактирования",
